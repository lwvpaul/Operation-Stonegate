...
if ((isset($_POST["WADbSearch1"])) && ($_POST["WADbSearch1"] != "")) {
  ...
  if (1 == 1) {
    $_SESSION["WADbSearch1_DesignCategoriesDelete"]=$WADbSearch1->whereClause;
  }
}
else     {
  $WADbSearch1 = new FilterDef;
  ...
  if (1 == 1)     {
    if (isset($_SESSION["WADbSearch1_DesignCategoriesDelete"]) && $_SESSION["WADbSearch1_DesignCategoriesDelete"] != "")     {
      $WADbSearch1->whereClause = $_SESSION["WADbSearch1_DesignCategoriesDelete"];
    }
    else     {
...
$query_rs_DesCatDelete = "SELECT * FROM product_cats";
setQueryBuilderSource($query_rs_DesCatDelete,$WADbSearch1,false);
$rs_DesCatDelete = mysql_query($query_rs_DesCatDelete, $GoCreate) or die(mysql_error());
$row_rs_DesCatDelete = mysql_fetch_assoc($rs_DesCatDelete);
$totalRows_rs_DesCatDelete = mysql_num_rows($rs_DesCatDelete);?>
<?php
...
<div class="GoCreateAdmin1">
        ...
        <div class='content cssLI GoCreateAdmin1_content_design'>
          ...
          <div class='cssLO GoCreateAdmin1_centercolumn_layout'>
            <div class='centercolumn cssLI GoCreateAdmin1_centercolumn_design'>
              ...
              <div id="HeaderTitle">Design Category Delete</div>
  ...
  <tr class="form_txt" style="text-align: center;">
	...
	while($RepeatSelectionCounter_1_IterationsRemaining--){
		if($RepeatSelectionCounterBasedLooping_1 || $row_rs_DesCatDelete){
?><tr class="roweffect">
<td class="form_txt"><?php echo $RepeatSelectionCounter_1+1; ?>.      
  
  <input type="hidden" name="WADA_RepeatID_ID_<?php echo $RepeatSelectionCounter_1; ?>" id="WADA_RepeatID_ID_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo $row_rs_DesCatDelete["ID"]; ?>" />
  <input name="C_ID_<?php echo $RepeatSelectionCounter_1; ?>" type="hidden" id="C_ID_<?php echo $RepeatSelectionCounter_1; ?>" value='<?php echo $row_rs_DesCatDelete["ID"]; ?>' /></td>
    <td class="form_txt"><?php echo $row_rs_DesCatDelete['TITLE_NAME']; ?></td>
 </tr>
   <?php
...
?>
    <?php } // RepeatSelectionCounter_1 End Alternate Content
		if(!$RepeatSelectionCounterBasedLooping_1 && $RepeatSelectionCounter_1_IterationsRemaining != 0){
			if(!$row_rs_DesCatDelete && $RepeatSelectionCounter_1_Iterations == -1){$RepeatSelectionCounter_1_IterationsRemaining = 0;}
			$row_rs_DesCatDelete = mysql_fetch_assoc($rs_DesCatDelete);
		}
...
<tr>
    <td colspan="2" style="text-align: right;"><input name="ConfirmDeletion" type="submit" class="cust_button" id="ConfirmDeletion" value="ConfirmDeletion" />
                      &nbsp;
...
<?php
mysql_free_result($rs_DesCatDelete);
?>
