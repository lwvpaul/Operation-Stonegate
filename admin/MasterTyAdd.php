...
if("" == ""){
	$WA_Master_Type_Insert_1301303760797 = new WA_Include("MasterType/Master_Type_Insert.php");
	require($WA_Master_Type_Insert_1301303760797->BaseName);
	$WA_Master_Type_Insert_1301303760797->Initialize(true);
}
...
<?php echo((isset($WA_footer_1300717372941))?$WA_footer_1300717372941->Head:"") ?><?php echo((isset($WA_sitestats_1301303033310))?$WA_sitestats_1301303033310->Head:"") ?><?php echo((isset($WA_Master_Type_Insert_1301303760797))?$WA_Master_Type_Insert_1301303760797->Head:"") ?>
</head>
        ...
        <div class='content cssLI GoCreateAdmin1_content_design'>
          ...
          <div class='cssLO GoCreateAdmin1_centercolumn_layout'>
            <div class='centercolumn cssLI GoCreateAdmin1_centercolumn_design'>
              <!-- centercolumn Content Starts Here --><?php echo((isset($WA_Master_Type_Insert_1301303760797))?$WA_Master_Type_Insert_1301303760797->Body:"") ?>
