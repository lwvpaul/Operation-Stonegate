...
if (isset($_POST["InsertAll"])) // Trigger
{
  ...
  $WA_loopedFields = array("CatName", "MENU_LEVEL_", "CatVis", "Icon", "editorField", "CatSection");
  ...
  while (WA_AB_checkMultiInsertLoopedFieldsExist($WA_loopedFields, $WA_multipleInsertCounter)) {
    if ($WA_insertIfNotBlank == "" || WA_AB_checkLoopedFieldsNotBlank(array($WA_insertIfNotBlank), $WA_multipleInsertCounter)) {
      $WA_fieldValuesStr = "".WA_AB_getLoopedFieldValue("CatName", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("MENU_LEVEL_", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("CatVis", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("Icon", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("editorField", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("CatSection", $WA_multipleInsertCounter)  ."";
...
<?php echo((isset($WA_cnt_loop_1306163184647))?$WA_cnt_loop_1306163184647->Head:"") ?><?php echo((isset($WA_catdropdown_1306166337432))?$WA_catdropdown_1306166337432->Head:"") ?>
</head>

<body class="pagebg" >
<p id="HeaderTitle">Design Category Add <span id="SubHeaderTitle">(icon size 232px wide)</span>
</p>
...
?>
    ...
    <td><span class="form_txt">
      ...
      <input name="CatName_<?php echo $RepeatSelectionCounter_1; ?>" type="text" class="form" id="CatName_<?php echo $RepeatSelectionCounter_1; ?>" />
    </span></td>
    <td><span class="form_txt">
      <input type="hidden" name="MENU_LEVEL__<?php echo $RepeatSelectionCounter_1; ?>" id="MENU_LEVEL__<?php echo $RepeatSelectionCounter_1; ?>" />
<?php 
if("" == ""){
...
?>
    <?php echo((isset($WA_catdropdown_1306166337432))?$WA_catdropdown_1306166337432->Body:"") ?>
	</span></td>
<td>
...
function toggle<?php echo $RepeatSelectionCounter_1; ?>() {
	...
	if(ele.style.display == "block") {
		...
		text.innerHTML = "Close Editor <?php echo $RepeatSelectionCounter_1+1; ?>";
                      ...
                      <div id="apDiv<?php echo $RepeatSelectionCounter_1; ?>" style="position:absolute; width:600px; height:120px; z-index:1; left: 47px; top: <?php echo $offset;?>px;display:none;"> <table width="120" border="0" align="center" cellpadding="0" cellspacing="0" class="form roweffect">
  <tr>
...
do {  
?>
<option value="<?php echo $row_rs_SectionOptions['Section']?>"<?php if (!(strcmp($row_rs_SectionOptions['Section'], "Non Retail"))) {echo " selected=\"selected\"";} ?>><?php echo $row_rs_SectionOptions['Section']?></option>
<?php
...
?>
    ...
    <td><div class="htmleditor_upload">
      <input name="Icon_<?php echo $RepeatSelectionCounter_1; ?>" type="text" class="form" id="Icon_<?php echo $RepeatSelectionCounter_1; ?>" style="float:left;" value="" readonly/>
    ...
    <tr class="form_txt">
      <td nowrap="nowrap">Add
        ...
        <select name="NewAdd" class="form" id="NewAdd" onchange="this.form.submit();">
         <?php echo((isset($WA_cnt_loop_1306163184647))?$WA_cnt_loop_1306163184647->Body:"") ?> 
        </select></td>
