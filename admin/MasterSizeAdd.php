...
if (isset($_POST["InsertAll"])) // Trigger
{
  ...
  $WA_loopedFields = array("MediaSize", "SZ_ID");
  ...
  $WA_fieldNamesStr = "MEDIA_SIZE|F_ID";
  $WA_columnTypesStr = "',none,''|none,none,NULL";
  $WA_insertIfNotBlank = "MediaSize";
  ...
  while (WA_AB_checkMultiInsertLoopedFieldsExist($WA_loopedFields, $WA_multipleInsertCounter)) {
    if ($WA_insertIfNotBlank == "" || WA_AB_checkLoopedFieldsNotBlank(array($WA_insertIfNotBlank), $WA_multipleInsertCounter)) {
      $WA_fieldValuesStr = "".WA_AB_getLoopedFieldValue("MediaSize", $WA_multipleInsertCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("SZ_ID", $WA_multipleInsertCounter)  ."";
...
if("" == ""){
	$WA_cnt_loop_1301390306459 = new WA_Include("GSNET_LIB/php/cnt_loop.php?cnt=10");
	require($WA_cnt_loop_1301390306459->BaseName);
	$WA_cnt_loop_1301390306459->Initialize(true);
}
...
<?php echo((isset($WA_cnt_loop_1301390306459))?$WA_cnt_loop_1301390306459->Head:"") ?>
</head>
...
<!-- leftcolumn Content Ends Here -->
          ...
          <div class='cssLO GoCreateAdmin1_centercolumn_layout'>
            <div class='centercolumn cssLI GoCreateAdmin1_centercolumn_design'>
              ...
              <div id="HeaderTitle">Master Size Insert <span class="HighLight"><?php echo $_GET['MT'];?></span></div>
...
?>
  <tr class="roweffect">
    <td class="form_txt"><?php echo $RepeatSelectionCounter_1+1; ?>.
      <input type="hidden" name="MediaSize_mihidden_<?php echo $RepeatSelectionCounter_1; ?>" id="MediaSize_mihidden_<?php echo $RepeatSelectionCounter_1; ?>" value="1" />
      <input name="SZ_ID_<?php echo $RepeatSelectionCounter_1; ?>" type="hidden" id="SZ_ID_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo $_GET['SZ_ID']; ?>" /></td>
    <td><input name="MediaSize_<?php echo $RepeatSelectionCounter_1; ?>" type="text" class="form" id="MediaSize_<?php echo $RepeatSelectionCounter_1; ?>" size="30" /></td>
  </tr>
  <?php
...
?>
  ...
  <div style="top: 10px; position: relative;">
                <table border="0" cellpadding="4" cellspacing="4" class="form">
                  <tr>
                    <td><span class="form_txt">Add</span>&nbsp;
                      <select name="NewAdd" class="form" id="NewAdd" onchange="this.form.submit();">
  <?php echo((isset($WA_cnt_loop_1301390306459))?$WA_cnt_loop_1301390306459->Body:"") ?>
                      </select></td>
                    <td><input name="InsertAll" type="submit" class="cust_button" id="InsertAll" value="InsertAll" />
                      &nbsp;&nbsp;
