...
<body>
<img src="<?php echo preg_replace('#plugins/cropper.*#','',$_SERVER['REQUEST_URI']); ?>get_thumb.php?id=<?php print $_GET['id'].'&'.rand(1,500).GET_PARAMS;?>" alt="Crop image" id="cropImage" width="<?php print $_GET['width'];?>" height="<?php print $_GET['height'];?>" />
</body>
</html>
