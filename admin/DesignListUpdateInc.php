...
if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_SERVER["HTTP_REFERER"]) && strpos(urldecode($_SERVER["HTTP_REFERER"]), urldecode($_SERVER["SERVER_NAME"].$_SERVER["PHP_SELF"])) > 0) && isset($_POST)) // Trigger
{
  ...
  $WA_indexField = "ID";
  $WA_fieldNamesStr = "DESIGN_NAME|DESIGN_REF|DESC_CAT|BREF_DESCIP|AMENDMENTS_ALLOWED|TEXT_HEADER|OPTIONS|MULTI_PACK";
  $WA_columnTypesStr = "',none,''|',none,''|none,none,NULL|',none,''|',none,''|',none,''|none,none,NULL|',none,''";
  ...
  while (WA_AB_checkLoopedFieldsNotBlank($WA_loopedIDField, $WA_multipleUpdateCounter)) {
    $WA_fieldValuesStr = "".WA_AB_getLoopedFieldValue("Dname", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("DRef", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("MENU_LEVEL_", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("editorField_", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("editorField_", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("editorField_", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("COptions", $WA_multipleUpdateCounter)  ."" . "|" . "".WA_AB_getLoopedFieldValue("Dmulti", $WA_multipleUpdateCounter)  ."";
...
?> 
  <tr class="roweffect">
    ...
    <td nowrap="nowrap" class="form_txt" scope="row">
        ...
        <?php echo((isset($WA_catdropdown_1303554110864))?$WA_catdropdown_1303554110864->Body:"") ?>
    </td>
